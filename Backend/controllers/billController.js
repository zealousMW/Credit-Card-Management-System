...
exports.addBill = async(req , res)=>{
    ...
    try{
    const {cardId, billDate, billedAmount, minPaymentDue} = req.body;
    ...
    const insertQuery =`INSERT INTO monthly_bills (card_id,bill_date, billed_amount,minimum_payment_due) VALUES (?,?,?,?)`;
    await db.query(insertQuery,[cardId, billDate, billedAmount, minPaymentDue]);
